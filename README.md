...
[![CI](https://github.com/coolms/core-application/actions/workflows/ci.yml/badge.svg)](https://github.com/coolms/core-application/actions/workflows/ci.yml)
[![Latest Version](https://img.shields.io/packagist/v/coolms/core-application)](https://packagist.org/packages/coolms/core-application)
...
> adapter provides it, so `composer require coolms/core-application` on its own
