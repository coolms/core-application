# Contributing to `coolms/core-app`
...
`coolms/core-app` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/core-app 2.0.0` does not assert that this package broke something; it
